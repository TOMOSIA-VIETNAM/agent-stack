...
/**
 * Tells a reader the file is generated, so edits go to the knowledge base.
 *
 * Attribution for imported content is not repeated here: it lives once in
 * .claude/aidd-manifest.json, which travels with the project the same way an
 * installed plugin's LICENSE travels with its checkout.
 */
function originComment(entry: SelectedArtifact): string {
