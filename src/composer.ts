 ...
 * .claude/agent-stack-manifest.json, which travels with the project the same way an
...
/**
 * A skill authored here carries agent-stack's selection metadata alongside
